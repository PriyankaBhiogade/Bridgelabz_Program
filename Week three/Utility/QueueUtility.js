...
var file = require('fs');
var util11 = require('../../Week two/Utility/Queue')
...
class StockAccount {
                ...
                for (let i in object1) {
                    if (object1[i].Symbol == this.sym) {
                        ...
                        if (n11 > number) {
                            ...
                            console.log()
                            console.log("Date of Buying the Share is:: " + (time.getDate()) + "/" + (time.getMonth() + 1) + "/" + (time.getFullYear()));
                            ...
                            if (this.count > 0) {
                                ...
                                for (let i = this.count; i <= this.count; i++) {
                                    ...
                                    for (var key in obj3.transaction) {
                                        this.queue1.push(obj3.transaction[key])
                                    }
                                    //obj3.transaction = this.stack1;
                                    this.queue1.push(obj3.transaction)
                        ...
                        if (n11 > number) {
                            ...
                            if (this.count > 0) {
                                ...
                                for (let i = this.count; i <= this.count; i++) {
                                    ...
                                    for (var key in obj3.transaction) {
                                        this.queue2.push(obj3.transaction[key])
                                    }
                                    //obj3.transaction = this.stack1;
                                    this.queue2.push(obj3.transaction)
    ...
    printSellQueue() {
        console.log()
        console.log("Cell Stock Symbol is:: " + this.queue2.pop());
